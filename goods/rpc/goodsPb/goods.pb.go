...
type GoodsInfoItem struct {
	...
	GoodsId       string                 `protobuf:"bytes,4,opt,name=goodsId,proto3" json:"goodsId,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GoodsInfoItem) GetGoodsName() string {
	if x != nil {
		return x.GoodsName
	}
	return ""
...
const file_proto_goods_proto_rawDesc = "" +
	...
	"\bgoodsIds\x18\x01 \x03(\tR\bgoodsIds\"s\n" +
	"\rGoodsInfoItem\x12\x1c\n" +
	"\tgoodsName\x18\x01 \x01(\tR\tgoodsName\x12\x14\n" +
	"\x05cover\x18\x02 \x01(\tR\x05cover\x12\x14\n" +
	"\x05price\x18\x03 \x01(\tR\x05price\x12\x18\n" +
	"\agoodsId\x18\x04 \x01(\tR\agoodsId\"A\n" +
	"\x15BatchGetGoodsInfoResp\x12(\n" +
	"\x04list\x18\x01 \x03(\v2\x14.goods.GoodsInfoItemR\x04list2\x8d\x03\n" +
	"\x05goods\x129\n" +
...
var file_proto_goods_proto_goTypes = []any{
	...
	(*GoodsInfoItem)(nil),         // 13: goods.GoodsInfoItem
	(*BatchGetGoodsInfoResp)(nil), // 14: goods.BatchGetGoodsInfoResp
}
var file_proto_goods_proto_depIdxs = []int32{
	...
	13, // 2: goods.BatchGetGoodsInfoResp.list:type_name -> goods.GoodsInfoItem
	...
	14, // 14: goods.goods.BatchGetGoodsInfo:output_type -> goods.BatchGetGoodsInfoResp
